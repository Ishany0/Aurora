...
import { Sparkles, Shield, ArrowRight, Lock, KeyRound } from "lucide-react";
...
export const LandingView: React.FC<LandingViewProps> = ({
  ...
  return (
    <div id="landing-view" className="relative min-h-[calc(100vh-4rem)] flex flex-col justify-between overflow-hidden bg-slate-950 text-slate-100">
      ...
      {/* Main Hero Container */}
      <section className="relative z-10 max-w-4xl mx-auto px-4 pt-12 pb-16 sm:pt-20 sm:pb-24 text-center space-y-8 animate-fade-in">
        ...
        {/* Primary Call-to-Action: Sign In with Google */}
        <div className="flex flex-col items-center justify-center gap-3 pt-2 max-w-sm mx-auto">
          <button
            id="landing-google-signin-btn"
            onClick={onSignIn}
            className="w-full px-8 py-4 rounded-2xl bg-gradient-to-r from-teal-400 via-sky-400 to-indigo-500 hover:from-teal-300 hover:to-indigo-400 text-slate-950 font-bold text-base shadow-xl shadow-teal-500/20 flex items-center justify-center gap-3 transition-all hover:scale-[1.02] cursor-pointer"
          >
          ...
          <p className="text-[11px] text-slate-500 text-center">
            Authenticate securely via Firebase to open your private reflection journal.
          </p>
        </div>
